...
public class Structure_main extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        {
            Intent intent=new Intent(Structure_main.this, Structure_theory.class);
