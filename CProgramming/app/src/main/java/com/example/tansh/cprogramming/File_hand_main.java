...
public class File_hand_main extends AppCompatActivity implements View.OnClickListener {
    private Button file_main, fprintf, fputc, fputs, fseek, ftell, rewind;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_file_hand_main);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == file_main.getId()) {
            Intent intent = new Intent(File_hand_main.this, File_hand_theory.class);
